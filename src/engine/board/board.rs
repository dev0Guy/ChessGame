...
//     }
//
//     fn match_symbol(cell: &Option<Piece>) -> &str {
//         match cell {
//             Some(Piece {piece_type: PieceType::King, side: Side::White }) => "WK",
//             Some(Piece {piece_type: PieceType::King, side: Side::Black }) => "BK",
//             Some(Piece {piece_type: PieceType::Queen, side: Side::White} ) => "WQ",
//             Some(Piece {piece_type: PieceType::Queen, side: Side::Black} ) => "BQ",
//             Some(Piece {piece_type: PieceType::Rook, side: Side::White}) => "WR",
//             Some(Piece {piece_type: PieceType::Rook, side: Side::Black}) => "BR",
//             Some(Piece {piece_type: PieceType::Bishop, side: Side::White}) => "WB",
//             Some(Piece {piece_type: PieceType::Bishop, side: Side::Black}) => "BB",
//             Some(Piece {piece_type: PieceType::Knight, side: Side::White}) => "WN",
//             Some(Piece {piece_type: PieceType::Knight, side: Side::Black}) => "BN",
//             Some(Piece {piece_type: PieceType::Pawn, side: Side::White}) => "WN",
//             Some(Piece {piece_type: PieceType::Pawn, side: Side::Black}) => "BN",
//             None => ".",
//         }
//     }
//
//     pub fn visualize(&self){
//         println!("{}", Self::FILE_NAMES);
//         for (rank, row) in self.0.iter().enumerate() {
//             print!("{} ", 8 - rank);
//             for cell in row.iter() {
//                 let symbol = Self::match_symbol(cell);
//                 print!("{:>2} ", symbol);
//             }
//             println!(" {}", 8 - rank);
//         }
